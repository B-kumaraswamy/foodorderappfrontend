...
import { updateCartList, updateFloatingMessage, updateInputValue, updateItems } from "./action"
...
function CartComponent(props) {
   ...
   const [loading, setLoading] = useState(true)
    console.log("restaurant in the cartlist..cart component",cartList)
...
if(loading) {
    ...
    return (
       <div>
            <HeadersComponent/>
            <img alt="image1" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSvYzlSqthCQMsDHH9hcDYVjCUPwGm_KuXhTw&s" className="emptycart-image"/>
...
export default connect(mapStatetoProps, {updateCartList, updateFloatingMessage, updateInputValue, updateItems})(CartComponent)
