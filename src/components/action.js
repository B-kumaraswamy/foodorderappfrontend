export const updateName = (name) => {
    console.log('inside the updateName action' ,name)
    return {
        type : "name",
        payload : name
    }
...
export const updateLoggedIn = (status) => {
    console.log("loggedIn action  in action.js",status)
    return {
        type : "loggedIn",
        payload : status
    }
...
export const updateQuantity = (itemId, quantity) => {
    console.log("itemId in the updateQuantity action", itemId)
    return {
        type : "updateQuantity",
        payload : {
            itemId, quantity
...
export const increaseQuantity = (itemId) => {
    console.log("inside increaseQuantity action", itemId)
    return {
