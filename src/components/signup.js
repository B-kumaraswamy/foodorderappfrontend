import { updateEmail, updateName, updatePassword, updatePhoneNumber, 
    updateErrorValues, updateFloatingMessage,
updateEmailError, updatePasswordError, updatePhoneError, updateNameError } from "./action"
...
function SignUp(props) {
    ...
    const onSignup = async() => {
        ...
        try {
            ...
            console.log("response from the backend on signup", response.data)
...
export default connect(mapStatetoProps, {
    updateName, updatePhoneNumber, updateEmail, updatePassword, 
    updateErrorValues, updateFloatingMessage,
    updateEmailError, updatePasswordError, updatePhoneError, updateNameError
